...
def main():
    ...
    if page == "Add Episode":
        render_add_episode_page(db, youtube_handler, transcript_processor)
    elif page == "Browse Episodes":
        render_browse_episodes_page(db, transcript_processor)
    elif page == "Search Transcripts":
        render_search_transcripts_page(db)
    elif page == "Database Management":
        render_database_management_page(db, transcript_processor)
